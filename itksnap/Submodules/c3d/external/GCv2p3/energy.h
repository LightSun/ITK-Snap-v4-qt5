...
{
public:
  typedef Graph<captype, tcaptype, flowtype> Superclass;
	typedef typename Superclass::node_id Var;
	...
	Energy(int node_num_max, int edge_num_max, void (*err_function)(const char *) = NULL);
...
::Energy(int node_num_max, int edge_num_max, void (*err_function)(const char *)) 
: Superclass(node_num_max, edge_num_max, err_function)
{
	Econst = 0;
...
template <typename captype, typename tcaptype, typename flowtype> 
inline Energy<captype,tcaptype,flowtype>
::~Energy() {}
...
inline void 
Energy<captype,tcaptype,flowtype>
::add_constant(Value A) 
{ 
  Econst += A; 
}

template <typename captype, typename tcaptype, typename flowtype> 
inline void Energy<captype,tcaptype,flowtype>
::add_term1(Var x,
                              Value A, Value B)
{
